...
## Conversión en diferentes tipos de objetos 
...
### Obtención del itemset en lista

```{r}
as(items(top5), "list")
```

### Obtención del itemset en formato matriz binaria

```{r}
as(items(top5), "matrix")
```

### Conjuntos de elementos como una matriz dispersa
